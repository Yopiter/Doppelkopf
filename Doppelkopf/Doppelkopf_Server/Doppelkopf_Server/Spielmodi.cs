...
namespace Doppelkopf_Server
{
    public partial class Program
    {
        ...
        static string[] NachrichtenListeEmo = { "Wow, {0} hast du die Runde überhaupt schon was gerissen?", "Schäm dich {0}", "Alle mit Namen {0} und {1} spielen den nächsten Stich blind. Dann hat das Glück bessere Chancen" , "Spieler {0} und {1} wurden durch Bots ersetzt, um ihren Teammitgliedern wenigstens eine Chance auf den Sieg zu bieten." };
